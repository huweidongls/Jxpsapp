...
public class DwcAdapter extends BaseAdapter {

    private Context context;
    private List<DqdEntity> data = new ArrayList<>();
    private LayoutInflater inflater;

    public DwcAdapter(Context context, List<DqdEntity> data) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.sure4.setVisibility(View.VISIBLE);
        holder.sure5.setVisibility(View.VISIBLE);

        holder.sure4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onItemClickListener.onClick(4, position);
            }
        });

        holder.sure5.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onItemClickListener.onClick(5, position);
            }
        });
